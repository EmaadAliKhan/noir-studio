      ...
      <Container className="py-16 md:py-24">
        ...
        <div className="grid grid-cols-2 md:grid-cols-12 gap-10">
          <div className="col-span-2 md:col-span-5">
            ...
            <div className="mt-6 flex items-center gap-2 text-ink-3 text-sm">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="text-ink-2">{BRAND.phone}</li>
              <li className="text-ink-2">{BRAND.city}</li>
            </ul>
          </div>
        ...
        <div className="mt-16 pt-8 border-t border-border flex flex-col md:flex-row md:items-center justify-between gap-4 text-xs text-ink-3 font-mono uppercase tracking-[0.18em]">
          <div>© {new Date().getFullYear()} {BRAND.name} Studio. All rights reserved.</div>
